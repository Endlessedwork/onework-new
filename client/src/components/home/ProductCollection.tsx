    ...
    <section id="collections" className="py-24 bg-secondary/30">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div>
            <span className="text-accent-foreground font-medium tracking-wide uppercase text-sm">Curated Selection</span>
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-primary mt-2">Standard Collections</h2>
          </div>
          <p className="text-muted-foreground max-w-md text-right md:text-left">
            Explore our ready-to-ship collections, thoughtfully designed to suit various hotel themes and atmospheres.
          </p>
        </div>
